...
- [ ] **Task: Verify and Sync Language Files**
    - [ ] Write Tests: Ensure translation keys exist for core entities (Device, Brand, Location).
    - [ ] Implement: Complete the `lang/id/*.php` files with missing translations.
